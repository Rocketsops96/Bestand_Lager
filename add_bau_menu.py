...
class Bau(customtkinter.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.selcteded_pdf_files.grid(row=14, column=0, padx=10, pady=(0,10), sticky = "e")

        self.create_bau = customtkinter.CTkButton(master=self.two_frame, corner_radius=5, height=30, width=250, border_spacing=5, text="Upload",
                                                fg_color=("gray70", "gray30"), text_color=("gray10", "gray90"), hover_color=("red"), font=customtkinter.CTkFont(size=14, weight="bold"),
    ...
    def create(self):
        ...
        cursor.execute(f"INSERT INTO Bau (name_bau, kostenstelle_vvo, bauvorhaben, ort, strasse, ausfurung_von, ausfurung_bis, vrao_ab, vrao_bis, ansprechpartner, status, pdf_data, meta_data , uberwachung, vzp, set_capo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",(name, kostenstelle_vvo, bauvorhaben, ort, strasse, ausfurung_von, ausfurung_bis, vrao_ab,vrao_bis, ansprechpartner, status, self.pdf_data, meta_data, uberwacht,vzp,set_capo))
